    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Real-time fleet management and analytics</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{analytics.daily_on_time_percentage}%</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-600">{analytics.active_buses}</p>
            </div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            <span className="text-blue-600">↗ 5</span> buses added this month
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-purple-600">{analytics.total_passengers.toLocaleString()}</p>
            </div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            <span className="text-purple-600">↗ 8.2%</span> from yesterday
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-orange-600">{analytics.average_waiting_time} min</p>
            </div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            <span className="text-red-600">↗ 1.2 min</span> from last week
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Daily On-Time Performance</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Daily Passenger Count</h2>
          <ResponsiveContainer width="100%" height={300}>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-900">Avg. Delay</th>
              ...
              {analytics.route_performance.map((route) => (
                <tr key={route.route_id} className="hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <span className="font-semibold text-blue-600">{route.route_id}</span>
                  </td>
                  <td className="py-4 px-4">
                  ...
                  <td className="py-4 px-4 text-gray-600">{route.average_delay} min</td>
                  <td className="py-4 px-4 text-gray-600">{route.passenger_count.toLocaleString()}</td>
                  <td className="py-4 px-4">
                    <span className={`px-2 py-1 text-xs rounded-full ${
                      route.on_time_percentage >= 90 ? 'bg-green-100 text-green-800' :
                      route.on_time_percentage >= 80 ? 'bg-yellow-100 text-yellow-800' :
